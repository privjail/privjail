...
def proto_method_req_name(cls, method):
    if method.__name__ == "__init__":
...
def proto_method_res_name(cls, method):
    if method.__name__ == "__init__":
...
def proto_instance_ref_name(cls):
